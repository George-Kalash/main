...
export default function RollingText() {
  return (
    <div className="min-w-2xs max-w-3/4 m-auto overflow-hidden">
      <div className="flex overflow-hidden perspective-[700px] h-100 self-center-safe justify-self-center-safe mt-52">
        <Marquee
          speed={600}
          className="ml-10 m-20 text-[100px] font-semibold text-center text-white"
